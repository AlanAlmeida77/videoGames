      ...
      <FormContainer>
        ...
        <FormMain onSubmit={onSubmit}>
          <InputContainer>
            ...
            <input className={errors.name && 'error'} type="text" name='name' id='name' onChange={handleInputChange} value={form.name} placeholder='ej: Call of Duty' />
          ...
          <InputContainer className='genreContainer'>
            ...
            <SelectedGenresContainer>
              {(!form.genres)
                ? ''
                : form.genres.map(genre => <GenreSpan key={genre}>{genre} <button value={genre} onClick={handleDeleteGenre}><div className='icon'>x</div></button></GenreSpan>)}
            </SelectedGenresContainer>
          </InputContainer>
